...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__port_folio__ = __webpack_require__(601);
...
var AllcoinPageModule = /** @class */ (function () {
    ...
    AllcoinPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__port_folio__["a" /* PortFolioPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__port_folio__["a" /* PortFolioPage */]),
...
//# sourceMappingURL=port-folio.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_socket_io_client__ = __webpack_require__(546);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_screenshot__ = __webpack_require__(313);
...
var PortFolioPage = /** @class */ (function () {
    function PortFolioPage(app, trackEvent, menu, zone, alertCtrl, socialSharing, screenshot, AuthData, loadingCtrl, navCtrl, http, navParams) {
        this.app = app;
        ...
        this.selectedSegment = this.Portfolio;
    ...
    PortFolioPage.prototype.ionViewWillLeave = function () {
        ...
        this.zone.run(function () {
            clearInterval(_this.intervalForValues);
        });
    };
    PortFolioPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.menu.swipeEnable(false);
        this.initializeTransactions().then(function () {
            for (var index = 0; index < _this.Transactions.length; index++) {
                _this.Transactions[index].Cost = _this.Transactions[index].CostInUSD;
            }
            _this.intervalForValues = setInterval(function () {
                console.log("sdfjk");
                for (var index = 0; index < _this.Transactions.length; index++) {
                    _this.getPrice(_this.Transactions[index].From, _this.ToSignSymbol, _this.Transactions[index].Exchange, index).then(function (PriceData) {
                        var a = {
                            From: _this.Transactions[PriceData.i].From,
                            Exchange: _this.Transactions[PriceData.i].Exchange,
                            Price: PriceData.price,
                            Change: PriceData.change
                        };
                        _this.gotNewPrice(a, "api");
                    });
                }
            }, 7000);
            _this.ValuesTransactions();
        });
        this.trackEvent.trackView("port folio");
    };
    PortFolioPage.prototype.getPrice = function (from, to, exchange, i) {
        var _this = this;
            ...
            if (from == to) {
                ...
                _this.http.get(url).toPromise().then(function (data) {
                    if (data.json().Response != undefined) {
                        ...
                        _this.convertion(from, toTmp, to, exchange, i).then(function (PriceData) {
                            resolve(PriceData);
                        })
                            .catch(function (i) {
                            reject(i);
    ...
    PortFolioPage.prototype.getOnPercent = function (OldPrice, NewPrice) {
    ...
    PortFolioPage.prototype.initializeTransactions = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]({
                'Content-Type': 'application/json'
            });
            var loading = _this.loadingCtrl.create({ duration: 10000 });
            loading.present();
            var dataFoServer = {
                UserUid: _this.AuthData.user._id
            };
            _this.http.post("http://afternoon-mountain-15657.herokuapp.com/api/getTransaction", JSON.stringify(dataFoServer), { headers: header }).toPromise()
                .then(function (res) {
                _this.Transactions = res.json();
    ...
    //TODO
    PortFolioPage.prototype.CloseTransaction = function (i, slidingItem) {
        var header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]({
            'Content-Type': 'application/json'
        });
    ...
    PortFolioPage.prototype.AddTransaction = function (i, slidingItem) {
        this.Transactions.push(i);
    };
    PortFolioPage.prototype.DeleteTransaction = function (i, slidingItem) {
        var _this = this;
        slidingItem.close();
        var header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        header.append('Content-Type', 'application/json');
        var loading = this.loadingCtrl.create({ duration: 10000 });
        var dataToServer = {
        ...
        this.http.post("http://afternoon-mountain-15657.herokuapp.com/api/DeleteTransaction", JSON.stringify(dataToServer), { headers: header }).toPromise()
            ...
            _this.trackEvent.trackEvent("port-folio", "delete transaction");
        });
        this.Transactions.splice(i, 1);
        this.calculateTotals();
    };
    PortFolioPage.prototype.convertion = function (fromRequire, toTmp, toRequire, exchange, i) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            ...
            //console.log(url1);
            //call cvc/btc
            _this.http.get(url1).toPromise().then(function (data1) {
                if (data1.json().Response != undefined) {
    ...
    PortFolioPage.prototype.calculateTotals = function () {
        var tmpTotalProfit = 0;
        var PortfolioValuetmp = 0;
        var TotalCosttmp = 0;
    ...
    PortFolioPage.prototype.changeTotalProfitShow = function () {
        if (this.IsProfitShowChange) {
            ...
            for (var index = 0; index < this.Transactions.length; index++) {
                var a = (this.Transactions[index].GainValue - this.Transactions[index].AmountMultCost);
    ...
    PortFolioPage.prototype.getOnValue = function (Price, CurrentPrice) {
        var result = 0;
        result = ((CurrentPrice - Price) / Price) * 100;
        return result;
    };
    PortFolioPage.prototype.ValuesTransactions = function () {
        var _this = this;
        var promise_i = 0;
        for (var index = 0; index < this.Transactions.length; index++) {
            this.Transactions[index]["AmountMultCost"] = this.Transactions[index]["Cost"] * this.Transactions[index]["Amount"];
            this.getPrice(this.Transactions[index].From, this.ToSignSymbol, this.Transactions[index].Exchange, index).then(function (PriceData) {
                _this.Transactions[PriceData.i]["CurrentPrice"] = Number(PriceData.price);
                _this.Transactions[PriceData.i]["CurrentChange24H"] = Number(PriceData.change);
                _this.Transactions[PriceData.i]["GainValue"] = _this.Transactions[PriceData.i].Amount * _this.Transactions[PriceData.i].CurrentPrice;
                //  this.Transactions[PriceData.i]["GainValue"] = Number(this.Transactions[PriceData.i]["GainValue"])
                _this.Transactions[PriceData.i]["Gain"] = _this.Transactions[PriceData.i]["GainValue"] - _this.Transactions[PriceData.i]["AmountMultCost"];
                promise_i++;
                if (promise_i == _this.Transactions.length) {
                    _this.calculateTotals();
                    _this.connectToSocket("https://streamer.cryptocompare.com/");
                }
            });
        }
    };
    PortFolioPage.prototype.changeShowMode = function () {
    ...
    PortFolioPage.prototype.clearBackground = function (i) {
        var _this = this;
        if (i != null) {
            setTimeout(function () {
                _this.Transactions[i].BackgroundColor = "none";
            }, 2000);
            return;
        }
        for (var index = 0; index < this.Transactions.length; index++) {
    ...
    PortFolioPage.prototype.connectToSocket = function (url) {
        console.log(this.Transactions);
        var all_pairs = [];
        var flag = true;
        for (var index = 0; index < this.Transactions.length; index++) {
            for (var j_index = 0; j_index < index; j_index++) {
        ...
        for (var i = 0; i < all_pairs.length; i++) {
            var channel = "2~" + all_pairs[i].Exchange;
            arr.push(all_pairs[i].From + "_" + TOSYM);
        }
        this.socket = __WEBPACK_IMPORTED_MODULE_3_socket_io_client__["connect"]("https://crypto.tradingcompare.com/");
    ...
    PortFolioPage.prototype.dataUnpack = function (data) {
    ...
    PortFolioPage.prototype.gotNewPrice = function (PriceData, str) {
        ...
        for (var index = 0; index < this.Transactions.length; index++) {
            ...
            if ((PriceData.Exchange == this.Transactions[index].Exchange) && (PriceData.From == this.Transactions[index].From)) {
                ...
                var k = this.Transactions[index]["CurrentPrice"];
                this.Transactions[index]["CurrentPrice"] = (Number(PriceData.Price));
                var b = Number(Number(100 * k) / Number(Number(this.Transactions[index].CurrentChange24H) + 100));
                this.Transactions[index]["CurrentChange24H"] = Number((PriceData.Price - b) / b) * 100;
                var a = this.Transactions[index]["GainValue"];
    ...
    PortFolioPage.prototype.addTransaction = function () {
        if (this.AuthData.user._id)
    ...
    PortFolioPage.prototype.toFixeNumber = function (num) {
        if (num == undefined)
            return 0;
        if (num == 0)
            return 0;
    ...
    PortFolioPage.prototype.share = function () {
        var _this = this;
        var loading = this.loadingCtrl.create();
        loading.present();
        loading.dismiss();
        this.screenshot.URI(80).then(function (res) {
            _this.socialSharing.share('Check out my portfolio !', 'Check out my portfolio !', res.URI, null).then(function () { return loading.dismiss(); }, function (err) {
                var alert = _this.alertCtrl.create({
                    title: 'Ooops!',
                    subTitle: err,
                    buttons: ['OK']
    ...
    PortFolioPage.prototype.EditTransaction = function (i, slidingItem) {
        slidingItem.close();
        this.navCtrl.push('port-folio-transaction', {
            transaction: this.Transactions[i]
        });
    };
    PortFolioPage.prototype.gotoHistory = function () {
        this.navCtrl.push("port_folio-historic");
    };
    PortFolioPage.prototype.onSlideChanged = function (slider) {
        console.log(slider);
        if (slider.getActiveIndex() == 3)
            return;
    ...
    PortFolioPage.prototype.changeSegment = function (segment) {
    ...
    PortFolioPage.prototype.gethistory = function () {
        var _this = this;
        var header = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        var loading = this.loadingCtrl.create({ duration: 10000 });
        loading.present();
        ...
        this.http.post("http://afternoon-mountain-15657.herokuapp.com/api/getClosedTransaction", JSON.stringify(dataFoServer), { headers: header })
            ...
            _this.TransactionsClosed = transition.json();
            for (var index = 0; index < _this.TransactionsClosed.length; index++) {
                _this.TransactionsClosed[index]["GainPrricePercent"] = _this.getOnPercent(_this.TransactionsClosed[index].CostInUSD, _this.TransactionsClosed[index].ClosedPrice);
            }
            loading.dismiss();
        })
            .catch(function (err) {
...
//# sourceMappingURL=port-folio.js.map
