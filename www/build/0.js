...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__allcoin__ = __webpack_require__(587);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_pipes_module__ = __webpack_require__(514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__directives_directives_module__ = __webpack_require__(544);
...
var AllcoinPageModule = /** @class */ (function () {
    ...
    AllcoinPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__allcoin__["a" /* AllcoinPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__allcoin__["a" /* AllcoinPage */]),
...
//# sourceMappingURL=allcoin.module.js.map
...
var hasBinary = __webpack_require__(536);
var sliceBuffer = __webpack_require__(558);
var after = __webpack_require__(559);
var utf8 = __webpack_require__(560);

var base64encoder;
if (typeof ArrayBuffer !== 'undefined') {
  base64encoder = __webpack_require__(561);
}
...
var Blob = __webpack_require__(562);
...
var binary = __webpack_require__(550);
var isArray = __webpack_require__(524);
var isBuf = __webpack_require__(532);
...
var hasCORS = __webpack_require__(555);
...
var XMLHttpRequest = __webpack_require__(529);
var XHR = __webpack_require__(556);
var JSONP = __webpack_require__(563);
...
var Transport = __webpack_require__(530);
var parseqs = __webpack_require__(525);
var parser = __webpack_require__(523);
var inherit = __webpack_require__(526);
var yeast = __webpack_require__(537);
...
var parser = __webpack_require__(527);
var Emitter = __webpack_require__(522);
var toArray = __webpack_require__(566);
var on = __webpack_require__(540);
var bind = __webpack_require__(541);
var debug = __webpack_require__(513)('socket.io-client:socket');
var parseqs = __webpack_require__(525);
var hasBin = __webpack_require__(536);
...
var url = __webpack_require__(547);
var parser = __webpack_require__(527);
var Manager = __webpack_require__(533);
...
exports.Manager = __webpack_require__(533);
...
var parseuri = __webpack_require__(531);
...
exports.humanize = __webpack_require__(549);
...
var transports = __webpack_require__(534);
var Emitter = __webpack_require__(522);
...
Socket.Transport = __webpack_require__(530);
Socket.transports = __webpack_require__(534);
...
if (typeof self === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(565);
  } catch (e) { }
} else {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AllcoinPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_socket_io_client__ = __webpack_require__(546);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_socket_io_client___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_socket_io_client__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_crypto_crypto__ = __webpack_require__(303);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_auth_data_auth_data__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_deeplinks__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_track_event_track_event__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_app_rate__ = __webpack_require__(312);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AllcoinPage = /** @class */ (function () {
    function AllcoinPage(navCtrl, authData, platform, zone, app, modalCtrl, trackEvent, deeplinks, cryptoProvider, appRate, navParams) {
        ...
        this.cryptoConterSquares = 20;
        this.cryptoSquares = [];
        this.CoinConnectedWSCrypto = [];
        this.ScrollFromTopCrypto = 0;
        this.ScrollDoneCrypto = true;
        this.cryptos = [];
        this.cryptosWatchlist = [];
        this.cryptosTrending = [];
        this.allcryptos = [];
    ...
    AllcoinPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        if (!this.authData.user._id)
            setTimeout(function () {
                ...
                var myModal = _this.modalCtrl.create("pop-up", null, myModalOptions);
                myModal.present();
            }, 10 * 1000);
    };
    AllcoinPage.prototype.buildCrypto = function () {
        var _this = this;
        this.CoinConnectedWSCrypto = [];
        this.cryptoProvider.getAllCrypto().then(function (data) {
            _this.allcryptos = data;
            console.log(_this.allcryptos);
            var arr = [];
            _this.doInfinite().then(function () {
                console.log(_this.numOfLines, " this.numOfLines");
                for (var index = 0; index < _this.cryptos.length; index++) {
                    if (index < _this.numOfLines) {
                        _this.CoinConnectedWSCrypto.push(_this.cryptos[index]);
                        arr.push(_this.cryptos[index].pair);
                    }
                }
                if (_this.content)
                    _this.content.scrollTop = _this.ScrollFromTopCrypto;
                _this.startWS(_this.CRYPTO);
                _this.addCoinWebsocketCrypto(arr);
            });
        });
        setTimeout(function () {
            console.log("appRate");
    ...
    AllcoinPage.prototype.addCoinWebsocketCrypto = function (arr) {
        console.log(arr, "addCoinWebsocketCrypto");
        this.socketCrypto.emit("room", arr);
    };
    AllcoinPage.prototype.leaveCoinWebsocketCrypto = function (arr) {
        console.log(arr, "leaveCoinWebsocketCrypto");
        this.socketCrypto.emit("leave_room", arr);
    };
    AllcoinPage.prototype.checkWsCrypto = function (scrollPx) {
        console.log(scrollPx);
        var SuposedToBe = [];
        var Todisconect = [];
        var Toconect = [];
        var a = Math.ceil(scrollPx / this.sizeOfLine) - 2;
        for (var j = 0; j < this.numOfLines; j++) {
            if (a + j > -1 && this.cryptos[a + j] != undefined) {
                SuposedToBe.push(this.cryptos[a + j]);
            }
        }
        console.log("sad", SuposedToBe);
        for (var j1 = 0; j1 < SuposedToBe.length; j1++) {
            var flag1 = false;
            for (var j2 = 0; j2 < this.CoinConnectedWSCrypto.length; j2++) {
        ...
        for (var j1 = 0; j1 < this.CoinConnectedWSCrypto.length; j1++) {
            var flag2 = false;
            for (var j2 = 0; j2 < SuposedToBe.length; j2++) {
    ...
    AllcoinPage.prototype.onScroll = function (event) {
    ...
    AllcoinPage.prototype.stopWS = function (str) {
        console.log("stop ws", str);
        if (this.socketCrypto != undefined) {
            this.socketCrypto.disconnect();
        }
    };
    AllcoinPage.prototype.startWS = function (str) {
        var _this = this;
        this.socketCrypto = __WEBPACK_IMPORTED_MODULE_2_socket_io_client__["connect"]("https://crypto.tradingcompare.com/");
        this.socketCrypto.on("message", function (data) {
            var pair = data.pair;
            for (var index = 0; index < _this.CoinConnectedWSCrypto.length; index++) {
                var a = index;
                if (pair == (_this.CoinConnectedWSCrypto[index].pair)) {
                    if (_this.CoinConnectedWSCrypto[a].price > Number(data.price)) {
                        _this.CoinConnectedWSCrypto[a].state = _this.CoinConnectedWSCrypto[a].state == "falling" ? "falling1" : "falling";
                        _this.CoinConnectedWSCrypto[a].price = Number(data.price);
                        // this.cryptos[a].high24 = Number(data.high24);
                        // this.cryptos[a].low24 = Number(data.low24);
                        _this.CoinConnectedWSCrypto[a].change = Number(data.change24);
                    }
                    else if (_this.CoinConnectedWSCrypto[a].price < Number(data.price)) {
                        _this.CoinConnectedWSCrypto[a].state = _this.CoinConnectedWSCrypto[a].state == "raising" ? "raising1" : "raising";
                        _this.CoinConnectedWSCrypto[a].price = Number(data.price);
                        // this.cryptos[a].high24 = Number(data.high24);
                        // this.cryptos[a].low24 = Number(data.low24);
                        _this.CoinConnectedWSCrypto[a].change = Number(data.change24);
    ...
    AllcoinPage.prototype.onSlideChanged = function (slider) {
        console.log(slider);
    ...
    AllcoinPage.prototype.changeSegment = function (segment) {
        ...
        switch (segment) {
            case this.CRYPTO:
                ...
                var arr = [];
                this.CoinConnectedWSCrypto = [];
                for (var index = 0; index < this.cryptos.length; index++) {
    ...
    AllcoinPage.prototype.sortByname = function () {
    ...
    AllcoinPage.prototype.sortByprice = function () {
        this.cryptos.sort(function (b, a) {
            if (a.price < b.price)
                return 1;
            if (a.price > b.price)
    ...
    AllcoinPage.prototype.sortBychange = function () {
        this.cryptos.sort(function (b, a) {
    ...
    AllcoinPage.prototype.addtoWhachlistT = function (pair, type, index) {
        console.log(pair, type, index);
        if (this.authData.user._id) {
            if (type) {
                this.cryptosTrending[index].isWatchlist = false;
                for (var index2 = 0; index2 < this.cryptosTrending.length; index2++) {
    ...
    AllcoinPage.prototype.addtoWhachlist = function (pair, type, index) {
        console.log(pair, type, index);
        if (this.authData.user._id) {
            if (type) {
    ...
    AllcoinPage.prototype.addtoWhachlistWATCHLIST = function (pair, type, index) {
        console.log(pair, type, index);
        if (this.authData.user._id) {
    ...
    AllcoinPage.prototype.buildWatchlist = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.CoinConnectedWSCrypto = [];
            _this.cryptosWatchlist = _this.cryptoProvider.mywatchlist;
            var arr = [];
            console.log(_this.cryptosWatchlist, "   this.cryptosWatchlist");
            for (var index = 0; index < _this.cryptosWatchlist.length; index++) {
                if (index < _this.numOfLines) {
                    _this.CoinConnectedWSCrypto.push(_this.cryptosWatchlist[index]);
                    arr.push(_this.cryptosWatchlist[index].pair);
                }
            }
    ...
    AllcoinPage.prototype.buildTrending = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.CoinConnectedWSCrypto = [];
            _this.cryptosTrending = _this.cryptoProvider.trending;
            var arr = [];
            for (var index = 0; index < _this.cryptosTrending.length; index++) {
                if (index < _this.numOfLines) {
                    _this.CoinConnectedWSCrypto.push(_this.cryptosTrending[index]);
                    arr.push(_this.cryptosTrending[index].pair);
                }
            }
            _this.content.scrollTop = _this.ScrollFromTopCrypto;
            _this.startWS(_this.CRYPTO);
    ...
    AllcoinPage.prototype.goEdit = function () {
        if (this.edit) {
            this.icon = "md-create";
            this.edit = false;
    ...
    AllcoinPage.prototype.reorderItems = function (indexes) {
        console.log(indexes);
        var element = this.cryptosWatchlist[indexes.from];
        this.cryptosWatchlist.splice(indexes.from, 1);
        this.cryptosWatchlist.splice(indexes.to, 0, element);
    };
    AllcoinPage.prototype.addcoin = function () {
    ...
    AllcoinPage.prototype.doInfinite = function () {
        var _this = this;
        console.log("do infinit", this.selectedSegment);
        return new Promise(function (resolve) {
            var index = 0;
            for (; (_this.offsetRequested + index) < _this.allcryptos.length && index < 20; index++) {
                _this.cryptos.push(_this.allcryptos[index + _this.offsetRequested]);
            }
            _this.offsetRequested += index;
            resolve();
        });
    };
    AllcoinPage.prototype.gotoChart = function (pair) {
        this.navCtrl.push("chart", { pair: pair });
    };
    AllcoinPage.prototype.gotovip = function () {
    ...
    AllcoinPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_crypto_crypto__["a" /* CryptoProvider */],
